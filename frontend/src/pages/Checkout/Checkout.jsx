        ...
        <div className="">
            {cartData.map((item) => (
              <div className="" key={item._id}>
                ...
                <p className="">{item.name}- Qty. {item.quantity}</p>
                <p className="">Individual Item Cost: ${item.price.toFixed(2)}</p>
                <p className="">Individual Cost x qty= ${getItemTotal(item.quantity, item.price).toFixed(2)}</p>
